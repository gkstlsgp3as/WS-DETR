...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--mean_query', action='store_true', help="whether to apply mean value of queries")
    ...
    parser.add_argument('--mil_loss_coef', default=2, type=float) # wsod
